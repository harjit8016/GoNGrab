...
actual fun AnimatedSvgView(
    ...
    Box(modifier = modifier.size(sizeDp.dp)) {
        AndroidView(
            ...
            update = { webView ->
                val dynamicallyCleaned = cleanSvg
                ...
                val htmlData = """
                    <!DOCTYPE html>
                    <html style="background: transparent !important; overflow: visible;">
                    <head>
                    ...
                    <body style="background: transparent !important; overflow: visible;">
